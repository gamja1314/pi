...
$(function(){
	...
	$("#btnSign").click(function(){
		...
		$.ajax({
			...
			url: "<c:url value='/memberRegSave.do' />",
			dataType: "json",
...
<%@ include file="/top/topmenu.jsp" %> 	
  ...
  <tr>
	...
	<tr>
		<td style="width:600px; padding-left:80px;">	
		<a float="right"; style="font-size:200%";>아이디 </a>
		<span class='wd'><input type='text' name="memId" id ="memId" placeholder="아이디를 입력해주세요." autofocus
		class='input_text'></td><td style="width:100px; padding-right:200px;">
		<input type="button" value="중복확인" onclick="idcheck()" class="sch_smit">
		</span></td>
	</tr>
	<tr>
		<td style="width:600px; padding-left:80px;"> 
		<a align="right"; style="font-size:200%";>패스워드 </a>
		<span class='wd2'><input type='password' name="memPwd" id="memPwd" 
		autocomplete="off" placeholder="비밀번호를 입력해주세요." class='input_text'>
		</span></td>
	</tr>
	<tr>
		<td style="width:600px; padding-left:80px;"> 
		<a align="right"; style="font-size:200%";>이메일 </a>
		<span class='wd'><input type='text' name="email" id="email"
		placeholder="이메일을 입력해주세요." class='input_text'>
		</span></td>
	</tr>
	<tr>
		<td style="width:600px; padding-left:80px;"> 
		<a align="right"; style="font-size:200%";>닉네임</a>
		<span class='wd'><input type='text' name="memName" id="memName"
		placeholder="닉네임을 입력해주세요."class='input_text'>
		</span></td>
	</tr>
	<tr>
		<br>
		<td><a style="padding-bottom:40px"> </a>
		<br></td>
	</tr>
	<tr>
		<td colspan="2" height="40">
		<input type="button" value="확 인" id="btnSign" class="sch_smit">
		<br>  
