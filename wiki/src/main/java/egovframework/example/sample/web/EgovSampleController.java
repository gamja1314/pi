...
public class EgovSampleController {
	...
	public String selectDeptDetail(DeptVO vo, ModelMap model) throws Exception{
		
		vo = deptService.selectDeptDetail(vo);
	...
	@RequestMapping(value="/deptDetailSave.do")
	public String updateDept(DeptVO vo) throws Exception {
		
		int cnt = deptService.updateDept(vo);
	...
	public String deleteDept(DeptVO vo) throws Exception {
		...
		int cnt = deptService.deleteDept(vo);
	...
	public String selectDeptList(ModelMap model) throws Exception {
		...
		list = deptService.selectDeptList();
